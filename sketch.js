...
function draw() {
  ...
  if(gameState==="l1") {
    ...
    for(var i = 0;i<1200;i = i+200) {
       ...
       image(path,-100,200,1500,330);
       spawnBubblies();
       image(flagImg,350,400,35,50);
       image(flagImg,450,400,35,50);
       image(flagImg,550,400,35,50);
       image(flagImg,650,400,35,50);
       image(flagImg,750,400,35,50);
       }
       ...
       if(gameState === "l2") {
         ...
         for(var i = 0;i<1200;i = i+100) {
          ...
          for(var i =0;i<1200;i++) {
           ...
           image(path,-100,100,1500,130);
           image(path,-100,300,1500,130);
           image(path,-100,500,1500,130);
...
function spawnBubblies() {
  if(frameCount%40 === 0) {
    bubblies = createSprite(0,365,20,20);
